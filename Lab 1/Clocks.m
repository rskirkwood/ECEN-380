...
s4 = [zeros(size(0:Ts:T2-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    ...
    cos(2*pi*D_flat4*(0:Ts:T4-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*D_flat4*(0:Ts:T4-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*A_flat4*(0:Ts:T2-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*G_flat4*(0:Ts:T8-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*F4*(0:Ts:T8-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*E_flat4*(0:Ts:T4-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*D_flat4*(0:Ts:T8-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*E_flat4*(0:Ts:T8-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
    cos(2*pi*F4*(0:Ts:T2-Tspace-Ts)) zeros(size(0:Ts:Tspace-Ts)) ...
